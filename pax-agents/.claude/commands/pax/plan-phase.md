...
**Orchestrator role:** Parse arguments, validate phase, research domain (unless skipped or exists), spawn pax-planner agent, verify plans with pax-plan-checker, iterate until plans pass or max iterations reached, present results.
...
**If not found:** Error - user should run `/pax:new-project` first.
...
Task(
  ...
  subagent_type="pax-phase-researcher",
...
## 8. Spawn pax-planner Agent

Display stage banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 PAX ► PLANNING PHASE {X}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
## 10. Spawn pax-plan-checker Agent
...
Spawn pax-planner with revision prompt:
...
- /pax:plan-phase {X} --research — re-research first
...
- [ ] pax-phase-researcher spawned if research needed
- [ ] Existing plans checked
- [ ] pax-planner spawned with context (including RESEARCH.md if available)
- [ ] Plans created (PLANNING COMPLETE or CHECKPOINT handled)
- [ ] pax-plan-checker spawned (unless --skip-verify)
