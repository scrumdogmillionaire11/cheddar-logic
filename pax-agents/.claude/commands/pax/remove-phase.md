...
- Example: `/pax:remove-phase 17` → phase = 17
- Example: `/pax:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /pax:remove-phase <phase-number>
Example: /pax:remove-phase 17
```
...
To abandon current work, use /pax:pause-work instead.
```
...
Would you like to:
- `/pax:progress` — see updated roadmap status
