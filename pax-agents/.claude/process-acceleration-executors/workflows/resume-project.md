...
<required_reading>
@./.claude/process-acceleration-executors/references/continuation-format.md
</required_reading>
...
**If .planning/ doesn't exist:** This is a new project - route to /pax:new-project
</step>
...
📋 [N] pending todos — /pax:check-todos to review
...
1. Resume interrupted agent [if interrupted agent found]
   OR
1. Execute phase (/pax:execute-phase {phase})
   OR
1. Discuss Phase 3 context (/pax:discuss-phase 3) [if CONTEXT.md missing]
   OR
1. Plan Phase 3 (/pax:plan-phase 3) [if CONTEXT.md exists or discuss option declined]
...
- **Plan phase** → Show command for user to run after clearing:
  ...
  **Also available:**
  - `/pax:discuss-phase [N]` — gather context first
  - `/pax:research-phase [N]` — investigate unknowns
