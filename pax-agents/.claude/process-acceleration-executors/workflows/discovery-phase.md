...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /pax:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ./.claude/process-acceleration-executors/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ./.claude/process-acceleration-executors/templates/discovery.md structure:
...
1. **Scope the discovery** using ./.claude/process-acceleration-executors/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ./.claude/process-acceleration-executors/templates/discovery.md
...
Use ./.claude/process-acceleration-executors/templates/discovery.md.
...
1. Discuss phase context (/pax:discuss-phase [current-phase])
2. Create phase plan (/pax:plan-phase [current-phase])
