...
function normalizeGame(rawGame, sport) {
  ...
  return {
    ...
    odds: {
      ...
      spreadSameBookAwayForHome: spreadExecution.same_book_away_for_home,
      spreadSameBookHomeForAway: spreadExecution.same_book_home_for_away,
      h2hSameBookAwayForHome: h2hExecution.same_book_away_for_home,
      h2hSameBookHomeForAway: h2hExecution.same_book_home_for_away,
