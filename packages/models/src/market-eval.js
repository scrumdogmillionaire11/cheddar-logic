...
function buildResult(card, ctx, status, reasonCodes, extra = {}) {
  ...
  return {
    ...
    model_edge: (card && card.edge) !== undefined ? (card.edge ?? null) : null,
    fair_price: (card && card.fair_price) !== undefined ? (card.fair_price ?? null) : null,
    win_probability: (card && card.win_probability) !== undefined ? (card.win_probability ?? null) : null,
