...
module.exports = {
  ...
  patchOddsSnapshotF5: db.patchOddsSnapshotF5,
  ...
  resolveSnapshotAge: db.resolveSnapshotAge,
  upsertPlayerShotLog: db.upsertPlayerShotLog,
  getPlayerShotLogs: db.getPlayerShotLogs,
  upsertPlayerBlkLog: db.upsertPlayerBlkLog,
  getPlayerBlkLogs: db.getPlayerBlkLogs,
  upsertPlayerBlkRates: db.upsertPlayerBlkRates,
  getPlayerBlkRates: db.getPlayerBlkRates,
