...
const LOGGED_TEAM_VARIANTS = [
  ...
  'St. Thomas (MN) Tommies',
  'UC Irvine Anteaters',
  // Additional unresolved NCAAM variants from odds_ingest_failures (2026-03-19)
  'Kennesaw St Owls',
  'Dayton Flyers',
  'VCU Rams',
  ...
  'Bodo/Glimt',
  'Paris Saint-Germain',
  // Additional unresolved soccer variants from odds_ingest_failures (2026-03-19)
  'Bournemouth',
  'Newcastle United',
  'Manchester United',
  'Tottenham Hotspur',
  ...
  'San Diego FC',
  'Real Salt Lake',
  // MLB (all 30 teams) — discovered from 2026-04-01 TEAM_MAPPING_UNMAPPED
