...
Last activity: 2026-03-14 - Completed quick task 39: automated injury filtering in pull_nhl_player_shots (checkInjuryStatus, fail-open), 7 hardening gaps in run_nhl_player_shots_model (32-team map, deterministic synthetic line, opponentFactor from team_metrics_cache, 1P flag, resolveCanonicalGameId, unconditional setCurrentRunId), migration 030, 15 new tests, and docs/PROP_MARKET_EXPANSION_GUIDE.md
