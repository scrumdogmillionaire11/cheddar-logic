...
**After this command:** Run `/pax:plan-phase [N]` to start execution.
</objective>
...
**Load milestone context (if exists, from /pax:discuss-milestone):**
...
- Check for MILESTONE-CONTEXT.md (from /pax:discuss-milestone)
...
Spawn 4 parallel pax-project-researcher agents with milestone-aware context:
...
`/pax:discuss-phase [N]` — gather context and clarify approach
...
**Also available:**
- `/pax:plan-phase [N]` — skip discussion, plan directly
...
- [ ] pax-roadmapper spawned with phase numbering context
- [ ] Roadmap files written immediately (not draft)
- [ ] User feedback incorporated (if any)
- [ ] ROADMAP.md created with phases continuing from previous milestone
- [ ] All commits made (if planning docs committed)
- [ ] User knows next step is `/pax:discuss-phase [N]`
