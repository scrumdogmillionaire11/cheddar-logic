---
name: pax:whats-new
description: See what's new in PAX since your installed version
---
...
**To fix:** `npx process-acceleration-executors-cc --global`
...
- URL: `https://raw.githubusercontent.com/glittercowboy/process-acceleration-executors/main/CHANGELOG.md`
...
```bash
cat ./.claude/process-acceleration-executors/CHANGELOG.md 2>/dev/null
```
...
**To update:** `npx process-acceleration-executors-cc --global`
```
