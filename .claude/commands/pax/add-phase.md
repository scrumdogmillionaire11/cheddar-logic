...
- Example: `/pax:add-phase Add authentication` → description = "Add authentication"
- Example: `/pax:add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /pax:add-phase <description>
Example: /pax:add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /pax:plan-phase {N} to break down)
...
**Also available:**
- `/pax:add-phase <description>` — add another phase
- Review roadmap
...
- Don't use decimal numbering (that's /pax:insert-phase)
- Don't create plans yet (that's /pax:plan-phase)
