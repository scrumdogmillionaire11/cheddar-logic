...
<execution_context>
<!-- Spawns pax-integration-checker agent which has all audit expertise baked in -->
</execution_context>
...
Verify cross-phase wiring and E2E user flows.",
  subagent_type="pax-integration-checker",
...
- /pax:complete-milestone {version} — proceed anyway (accept tech debt)
