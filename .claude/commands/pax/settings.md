---
name: pax:settings
description: Configure PAX workflow toggles and model profile
allowed-tools:
  - Read
  - Write
  - AskUserQuestion
...
**If not found:** Error - run `/pax:new-project` first.
...
These settings apply to future /pax:plan-phase and /pax:execute-phase runs.

Quick commands:
- /pax:set-profile <profile> — switch model profile
- /pax:plan-phase --research — force research
- /pax:plan-phase --skip-research — skip research
- /pax:plan-phase --skip-verify — skip plan check
```
