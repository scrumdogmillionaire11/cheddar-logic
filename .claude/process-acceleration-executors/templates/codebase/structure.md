...
```
process-acceleration-executors/
├── bin/                # Executable entry points
├── commands/           # Slash command definitions
│   └── pax/           # PAX-specific commands
├── process-acceleration-executors/     # Skill resources
...
**process-acceleration-executors/references/**
...
**process-acceleration-executors/templates/**
...
**process-acceleration-executors/workflows/**
...
**New Slash Command:**
- Primary code: `commands/pax/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `process-acceleration-executors/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `process-acceleration-executors/workflows/{name}.md`
- Usage: Reference from command with `@./.claude/process-acceleration-executors/workflows/{name}.md`

**New Reference Document:**
- Implementation: `process-acceleration-executors/references/{name}.md`
