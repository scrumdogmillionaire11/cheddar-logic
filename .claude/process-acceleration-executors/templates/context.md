...
- `pax-phase-researcher` — Reads decisions to focus research (e.g., "card layout" → research card component patterns)
- `pax-planner` — Reads decisions to create specific tasks (e.g., "infinite scroll" → task includes virtualization)
...
- `pax-phase-researcher` uses decisions to focus investigation
- `pax-planner` uses decisions + research to create executable tasks
