...
Exit skill and invoke SlashCommand("/pax:plan-phase [X+1]")
...
**Also available:**
- `/pax:discuss-phase [X+1]` — gather context first
- `/pax:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/pax:complete-milestone {version}")
