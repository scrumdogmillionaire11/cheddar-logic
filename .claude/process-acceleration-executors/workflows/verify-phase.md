...
<required_reading>
@./.claude/process-acceleration-executors/references/verification-patterns.md
@./.claude/process-acceleration-executors/templates/verification-report.md
</required_reading>
...
<!-- Goal-backward derivation expertise is baked into the pax-verifier agent -->
</step>
...
See ./.claude/process-acceleration-executors/templates/verification-report.md for complete template.
</step>
