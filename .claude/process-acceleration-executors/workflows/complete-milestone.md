...
2. Read `./.claude/process-acceleration-executors/templates/milestone-archive.md` template
...
**Important:** The next milestone workflow starts with `/pax:new-milestone` which includes requirements definition. PROJECT.md's Validated section carries the cumulative record across milestones.
...
- [ ] User knows next step (/pax:new-milestone)
