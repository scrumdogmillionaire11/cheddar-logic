...
export const EDUCATION_ARTICLES: EducationArticle[] = [
  {
    ...
    resources: [
      { label: 'Official FPL Rules', href: 'https://fantasy.premierleague.com/help/rules', external: true },
  ...
  },
  {
    ...
    summary: 'Learn how expected value helps rank options when outcomes are uncertain.',
    intro:
