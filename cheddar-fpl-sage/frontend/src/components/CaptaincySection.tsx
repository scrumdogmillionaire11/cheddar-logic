      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-baseline gap-3">
            ...
            {captain.expected_pts !== undefined && captain.expected_pts !== null && captain.expected_pts > 0 && (
        ...
        <div className="pt-4 border-t border-surface-elevated space-y-2">
          ...
          <div className="flex items-baseline gap-3">
            ...
            {viceCaptain.expected_pts !== undefined && viceCaptain.expected_pts !== null && viceCaptain.expected_pts > 0 && (
              <span className="text-body-sm text-sage-muted">
