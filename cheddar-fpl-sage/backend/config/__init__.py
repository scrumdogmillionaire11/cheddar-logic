...
This package merges the original flat config module (settings, CORS helpers)
with the new risk-posture config introduced in WI-0707.
"""
import logging
...
class Settings(BaseSettings):
    ...
    UNLIMITED_TEAMS: str = "711511,1930561"
...
# ── Risk Posture config (WI-0707) ───────────────────────────────────────────
from backend.config.risk_posture import (  # noqa: E402
