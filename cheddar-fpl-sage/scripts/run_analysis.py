#!/usr/bin/env python3
"""
FPL Sage Enhanced Runner - Optimized Structure
Main entry point for FPL analysis with organized structure
"""
...
async def run_demo():
    ...
    try:
        ...
        if 'my_team' in raw_data and 'error' not in raw_data['my_team']:
            ...
            print("   2. Add it to config/team_config.json")
...
def show_improvements():
    ...
    print("\n🎯 FPL SAGE - ENHANCED SYSTEM:")
    print("-" * 50)
    
    print("✅ Enhanced Team Analysis")
    print("   - Personal team data integration")  
    print("   - Chip status tracking")
    print("   - Risk scenario quantification")
    
    print("\n✅ Improved Decision Framework") 
    print("   - Explicit downside scenarios")
    print("   - Forward-looking chip setup")
    print("   - Tilt armor protection")
...
async def main():
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "--demo":
        ...
        print("🔧 FPL Sage Enhanced - Optimized Structure")
        print("=" * 50)
        
        show_improvements()
        
        print("\n" + "="*50)
        print("🏃‍♂️ Ready to run enhanced analysis!")
        print("="*50)
